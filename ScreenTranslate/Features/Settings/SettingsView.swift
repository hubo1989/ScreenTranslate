        ...
        VStack(alignment: .leading, spacing: 8) {
            HStack {
                if viewModel.isPaddleOCRInstalled {
                    Image(systemName: "checkmark.circle.fill")
                        .foregroundStyle(.green)
                    Text(L("settings.paddleocr.installed"))
                        .foregroundStyle(.secondary)
                    ...
                    Image(systemName: "xmark.circle.fill")
                        .foregroundStyle(.orange)
                    Text(L("settings.paddleocr.not.installed"))
                        .foregroundStyle(.secondary)
                }
                ...
                .buttonStyle(.borderless)
                .help(L("settings.paddleocr.refresh"))
            }
            ...
            if !viewModel.isPaddleOCRInstalled {
                HStack(spacing: 8) {
                    Button {
                        ...
                        if viewModel.isInstallingPaddleOCR {
                            ProgressView()
                                .controlSize(.small)
                            Text(L("settings.paddleocr.installing"))
                        } else {
                            Image(systemName: "arrow.down.circle")
                            Text(L("settings.paddleocr.install"))
                        }
                    }
                    .buttonStyle(.borderedProminent)
                    .controlSize(.small)
                    ...
                    Button {
                        ...
                        Text(L("settings.paddleocr.copy.command"))
                    }
                ...
                Text(L("settings.paddleocr.install.hint"))
                    .font(.caption)
                    .foregroundStyle(.secondary)
            }
        }
