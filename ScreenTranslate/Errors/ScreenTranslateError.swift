...
/// Typed error enum for all ScreenTranslate failure cases.
/// Provides localized descriptions and recovery suggestions for user-friendly error handling.
enum ScreenTranslateError: LocalizedError, Sendable {
    // MARK: - Capture Errors
...
extension ScreenTranslateError {
    /// Creates a capture failure error with a sendable error description
    static func captureError(message: String) -> ScreenTranslateError {
